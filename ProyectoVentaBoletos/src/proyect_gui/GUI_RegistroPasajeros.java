...
public class GUI_RegistroPasajeros extends javax.swing.JFrame {
    ...
    private void btn_p_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_p_guardarActionPerformed
        ...
        if(txt_p_nombre.getText().isEmpty()){
            smsError +="- Ingrese un Nombre del Pasajero \n";
            c ++;
        }
        
        if(txt_p_apellido.getText().isEmpty()){
            smsError +="- Ingrese el Apellido del Pasajero \n";
            c ++;
        }
        
        if(txt_p_pasajero.getText().isEmpty()){
            smsError +="- Ingrese el tipo de pasajero \n";
            c ++;
        }
        
        if(txt_p_cedula.getText().isEmpty()){
            smsError +="- Ingrese la cedula del pasajero \n";
            c ++;
        }
        
        if(txt_p_edad.getText().isEmpty()){
            smsError +="- Ingrese la edad del pasajero \n";
            c ++;
        }
