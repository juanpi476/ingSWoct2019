...
public class GUI_RegistroUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_u_id_busca.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_u_id_buscaActionPerformed(evt);
            }
        });
    ...
    private void btn_u_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_u_guardarActionPerformed
        ...
        if(txt_u_id.getText().isEmpty()){
            smsError +="- Ingrese un ID \n";
            c ++;
        }
        
        if(txt_u_nombre.getText().isEmpty()){
            smsError +="- Ingrese un Nombre \n";
            c ++;
        }
        
        if(txt_u_apellido.getText().isEmpty()){
            smsError +="- Ingrese un Apellido \n";
            c ++;
        }
        
        if(txt_u_user.getText().isEmpty()){
            smsError +="- Ingrese un Nombre de Usuario \n";
            c ++;
        }
        
        if(txt_u_password.getText().isEmpty()){
            smsError +="- Ingrese una Contrasena \n";
            c ++;
        }
    ...
    private void btn_u_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_u_eliminarActionPerformed
       String data = ".\\usuario.txt";
       File archivo = new File (data);
       String idTest= txt_u_id_busca.getText().trim();
       try {
    ...
    private void txt_u_id_buscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_u_id_buscaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_u_id_buscaActionPerformed
